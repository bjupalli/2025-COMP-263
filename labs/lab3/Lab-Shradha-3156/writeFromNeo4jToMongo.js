// labs/lab3/Lab3-Pujari-03156/writeFromNeo4jToMongo.js
...
async function main() {
    ...
    try {
        await mongo.connect();
        const col = mongo.db(process.env.MONGO_DB).collection(process.env.MONGO_LAKE_COLLECTION);
    ...
    `);
        ...
        const author = process.env.AUTHOR_NAME || 'Unknown Author';
        ...
        if (docs.length) {
            ...
            console.log(`Inserted ${docs.length} Neo4j documents into Mongo lake (author="${author}").`);
        } else {
